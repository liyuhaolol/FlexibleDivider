...
centralPortal {
    ...
    name = "FlexibleDivider"
    group = "io.github.liyuhaolol"
    version = "1.4.0"
    pom {
        //packaging = "aar"
        name = "FlexibleDivider"
        description = "FlexibleDivider"
        url = "https://github.com/liyuhaolol/FlexibleDivider"
        licenses {
            license {
                name = "Apache License"
                url = "https://github.com/liyuhaolol/FlexibleDivider/blob/master/LICENSE"
            }
        }
        developers {
            developer {
        ...
        scm {
            connection = "scm:git@github.com/liyuhaolol/FlexibleDivider.git"
            developerConnection = "scm:git@github.com/liyuhaolol/FlexibleDivider.git"
            url = "https://github.com/liyuhaolol/FlexibleDivider"
        }
